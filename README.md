...
| [annotator/](annotator/README.md) | A local, no-build web viewer for authoring `plant`/rest-blend/fists visually, and for hand-correcting the depth/jump-height a monocular estimator gets wrong |
